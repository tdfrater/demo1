...
public class Lab2Tfrater
{
	...
	{
		System.out.println("\n You will be given amino acid full names. Your job is to give the one letter code case is not an issue");
	...
	public static void main(String[] args) 
	{
		...
		ranAmino_time(Long.parseLong(timeChoice_user));
		}
